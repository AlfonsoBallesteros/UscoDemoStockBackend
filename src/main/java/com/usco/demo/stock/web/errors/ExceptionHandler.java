...
import com.usco.demo.stock.config.ApplicationProperties;
 ...
 */
@ControllerAdvice
public class ExceptionHandler extends ResponseEntityExceptionHandler implements IExceptionHandler {
    ...
    private List<FieldError> getFieldErrors(WebExchangeBindException ex) {
        return ex
            .getBindingResult()
            .getFieldErrors()
            .stream()
    ...
    private String getCustomizedErrorDetails(Throwable err) {
        ...
        if (activeProfiles.contains(ApplicationProperties.SPRING_PROFILE_PRODUCTION)) {
    ...
    private HttpHeaders buildHeaders(Throwable err) {
        return err instanceof BadRequestException badRequestAlertException
